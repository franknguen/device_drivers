...
{ 
    [4] = {.name = "f_platA1x",.driver_data = PCDEVA1X}, 
    [5] = {.name = "f_platB1x",.driver_data = PCDEVB1X}, 
    [2] = {.name = "f_platC1x",.driver_data = PCDEVC1X}, 
    [3] = {.name = "f_platD1x",.driver_data = PCDEVD1X}, 
    { } /*Null termination */ 
}; 
...
{ 
    ...
    .id_table = pcdevs_ids, 
    .driver   = { 
        .name = "fplat-char-device" 
    } 
}; 

/***************************************************************************************/ 
static int __init f_plat_driver_init(void) 
{ 
    int ret; 
    ...
    pcdrv_data.class_pcd = class_create(THIS_MODULE,"frk_plat_class"); 
...
static void __exit f_plat_driver_exit(void) 
{ 
...
/***************************************************************************************/ 
module_init(f_plat_driver_init); 
module_exit(f_plat_driver_exit); 

MODULE_LICENSE("GPL"); 
MODULE_AUTHOR("FRANK"); 
MODULE_DESCRIPTION("HALLO-PLATFORM-DRIVER"); 
